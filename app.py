...
if option == "Upload CSV":
    st.write("Upload a CSV file with columns: name, roll_no, hours, attendance, cgpa/percentage, assignments, internal_marks, course, branch, section")
    ...
    if uploaded_file is not None:
        ...
        X = data[["hours", "attendance", "cgpa", "assignments", "course"]]
