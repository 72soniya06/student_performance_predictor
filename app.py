...
st.set_page_config(
    ...
    page_icon="shambhu_sense.jpg",  # <-- yaha tumhari file ka naam
    layout="centered"
)
st.image("shambhu_sense.jpg", width=120)  # logo upar dikhega
st.title("📚 Shambhu Sense - Student Performance Predictor")
st.write("Enter student details to predict final exam score (0-100).")
